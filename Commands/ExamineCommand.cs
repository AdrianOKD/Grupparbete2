...
namespace Grupparbete2.Commands
{
    public class ExamineOrangeCommand : Command
    {
        ...
        public override void Execute(string argument)
        {
            ...
            {
                Console.WriteLine($"You walk up to examine the {argument}. ");
            ...
            {
                System.Console.WriteLine($"You walk up to examine the {argument}");
    ...
    public class ExamineRedCommand : Command
    {
        ...
        public override void Execute(string args)
        {
            if (args == "platform")
            {
                Console.WriteLine("");
                Console.WriteLine(
                    $"As you approach the platform, you see that there are three {Colours.CYAN}jugs{Colours.NORMAL} in ominous uneven shapes placed upon it."
                );
                Console.WriteLine(
                    $"How could these {Colours.CYAN}jugs{Colours.NORMAL} possibly help you escape this place? Perhaps you should look at them a bit closer..."
                );
            }
            if (args == "jugs")
            {
                ...
                Console.WriteLine(
                    "Something about them makes you incredibly uneasy and you turn away in disgust."
                );
                Console.ReadLine();
                Console.WriteLine(
                    $"These jugs seem like they will be used for something important. Perhaps the time has come to '{Colours.ORANGE}Start Puzzle{Colours.NORMAL}'?"
                );
            }
            if (args == "door")
            {
                Console.WriteLine("");
                Console.WriteLine(
                    $"The door is shut, steel bars locking it firmly in place. You will need to find another way to exit this {Colours.CYAN}room{Colours.NORMAL}."
                );
            }
            if (args == "room")
            {
                Console.WriteLine("");
                Console.WriteLine(
                    $"The room is almost fully dark with an strange metallic smell in the air."
                );
                Console.WriteLine(
                    $"A very dim light reveal a {Colours.CYAN}platform{Colours.NORMAL} in the center with something placed on it."
                );
            }
        }
    }
